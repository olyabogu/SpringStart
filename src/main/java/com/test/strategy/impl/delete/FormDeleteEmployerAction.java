...
@Component
public class FormDeleteEmployerAction implements Action {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws SQLException, IOException, ServletException {
        ...
        try {
            ...
            req.getServletContext().getRequestDispatcher("/jsp/employee/deleteEmployer.jsp").forward(req, resp);
            return;
        }
        String destination = "/jsp/employee/deleteEmployer.jsp";
